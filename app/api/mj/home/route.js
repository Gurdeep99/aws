...
export async function GET(req) {
  ...
  function getBannerData() {
    const bannerData = [
      "https://aws.gurdeep.net/mj/banner.png",
      "https://aws.gurdeep.net/mj/banner2.png",
      "https://aws.gurdeep.net/mj/banner3.png",
      "https://aws.gurdeep.net/mj/banner4.png",
    ];

    const randomIndex = Math.floor(Math.random() * bannerData.length);

    return bannerData[randomIndex];
  }
